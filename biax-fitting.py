...
df = pd.read_excel(io='/Users/ankushaggarwal/Documents/Dropbox/BiaxialFitting_Ankush/ConstantInvariant_DrAggarwal_0517212.xlsx',sheet_name='TVAL1',header=[0,1])
...
sample.disp_controlled(inp,c_all)
